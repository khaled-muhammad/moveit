      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={`text-xs px-2 py-1 rounded-full ${getShareTypeColor(
                share.share_type
              )} bg-opacity-20`}
            >
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {activeTab === "shared-with-me" &&
                sharedBeams.map((share) => renderBeamCard(share.beam, true))}
              ...
              {activeTab === "my-beams" && beams.length === 0 && (
                <div className="col-span-full text-center py-20">
                  ...
                  <p className="text-gray-400 mb-6">
                    Create your first beam to get started
                  </p>
              ...
              {activeTab === "shared-with-me" && sharedBeams.length === 0 && (
                <div className="col-span-full text-center py-20">
                  ...
                  <p className="text-gray-400">
                    No one has shared any beams with you yet
                  </p>
                </div>
              )}
              ...
              {activeTab === "my-shares" && myShares.length === 0 && (
                <div className="col-span-full text-center py-20">
                  ...
                  <p className="text-gray-400">
                    You haven't shared any beams with others yet
                  </p>
                </div>
              )}
            </div>
        ...
        {showShareModal && selectedBeam && (
          ...
          >
            <motion.div
              ...
              style={{
                boxShadow:
                  "0 0 40px rgba(127, 90, 240, 0.2), inset 0 0 20px rgba(127, 90, 240, 0.05)",
              }}
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white goldman-regular">
                    Share Beam
                  </h3>
                  <p className="text-gray-400 text-sm">
                    {selectedBeam.beam_name || "Untitled Beam"}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setShareData({ ...shareData, share_type: e.target.value })
                    }
            ...
            >
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 mb-6">
                <p className="text-red-300 text-sm">
                  ...
                  <strong>{selectedShare.shared_with.username}</strong>?
                </p>
              </div>
