          ...
          <div className="prose prose-invert max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                By accessing and using Airsynca ("the Service"), operated by Airsynca ("we," "us," or "our") at airsynca.com, you accept and agree to be bound by the terms and provision of this agreement.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                To the maximum extent permitted by law, Airsynca shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or use.
              </p>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                You agree to indemnify and hold harmless Airsynca, its officers, directors, employees, and agents from any claims, damages, or expenses arising from your use of the Service or violation of these Terms.
              </p>
            </section>
